all:
	make mruby
	valac src/mruby.vala src/module.vala src/context.vala --vapidir=./vapi --pkg mruby --pkg gobject-introspection-1.0 -H mruby_vala.h -g -X -fPIC --library=mruby-vala --gir=MRuby-0.1.gir -o libmruby-vala.so -X -shared -X -fPIC -X -lm -X -lmruby
	make gir
